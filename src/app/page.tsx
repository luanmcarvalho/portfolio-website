...
export default function Home () {
  ...
  return (
    <>
      <header className='fixed top-0 left-0 w-full bg-white bg-opacity-50 backdrop-blur-md p-6 z-50'>
      ...
      <main>
        <section className='flex mt-60 px-36 div-img'>
          ...
          <div className='flex-1 ml-16 relative group cursor-pointer'>
            ...
            <Image src='/images/wizard-thumb.jpg' alt='Wizard brand redesign project - Featured Project' width={800} height={800} className='w-full h-auto' priority/>
          </div>
        </section>
        ...
        <section className="relative mt-60" id='animation'>
          <div className="z-40">
          ...
          <div className="flex justify-center">
            {showAll ? (
              <button onClick={() => setShowAll(false)} className="text-2xl font-organica text-gray-500 hover:text-black hover:scale-105 transition-all duration-300">Show Less</button>
            ) : (
              filteredProjects.length > 4 && (
                <button onClick={() => setShowAll(true)} className="text-2xl font-organica text-gray-500 hover:text-black hover:scale-105 transition-all duration-300">Show More</button>
              )
            )}
          </div>
        </section>

        <section className='mt-60' id='dev'>
        ...
        <section className='container mx-auto mt-10 flex flex-col lg:flex-row'>
          <div className='flex-1 flex-col space-y-4 lg:mr-5 mb-10 lg:mb-0'>
            <h2 className="text-6xl font-organica text-center mt-36"  id='about'>About</h2>
            ...
            <div className='container mx-auto mt-30 flex'>
              <div className='flex-1 flex-col space-y-4 mr-5'>
                ...
                <p className='font-organicaLight text-2xl'>When I&apos;m not designing or learning something new, you&apos;ll find me enjoying movies, exploring video games, or spending quality time with my wife and my baby daughter, my greatest source of inspiration.</p>
